    ...
    <div class="flex justify-center items-center md:mt-20">
        <div class="mx-auto w-10/12 md:w-6/12 lg:w-4/12 xl:w-4/12 md:bg-white md:rounded-3xl md:p-10 md:shadow-md">
            ...
            <form  action="{{ route('addlist.store') }}" method="POST">
                ...
                <div class="flex -mx-3">
                    <div class="w-full px-3 mb-5">
                        <button type="submit" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 transition duration-500 hover:scale-105 text-white rounded-lg px-3 py-3 font-semibold">{{ __('Create list') }}</button>
                    </div>
                </div>
            </form>
        </div>
