<x-app-layout>
    ...
    <main class="my-8">
        <div class="w-10/12 mx-auto">
            ...
            <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-">
                <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden mt-3 mb-3">
