    ...
    <div class="pt-10 flex justify-center items-center md:mt-20">
        <div class="mx-auto w-10/12 md:w-6/12 lg:w-4/12 xl:w-4/12 md:bg-white md:rounded-3xl md:p-10 md:shadow-md">
            <div class="flex items-center justify-between mb-5 px-1">
                ...
                <a href="{{ route('items', $list) }}" class="transition duration-500 hover:scale-115">
                    <span class="material-symbols-outlined">
                        close
                    </span>
                </a>
            ...
            @if (session('success'))
                <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 2000)">
                    <div class="z-10 absolute top-24 left-1/2 transform -translate-x-1/2 text-[#1E3A4C] md:w-5/12 w-11/12">
            ...
            @endif
            <div class="w-full mx-auto md:overflow-y-auto md:h-[32rem] md:scrollbar-thin md:scrollbar-thumb-indigo-700 md:scrollbar-track-indigo-300 md:scrollbar-thumb-rounded-full md:scrollbar-track-rounded-full">
